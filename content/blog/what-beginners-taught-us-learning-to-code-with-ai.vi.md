...
1. **Hãy ghi công cho người dùng, đừng ghi cho AI.** "Bạn vừa tóm được con bug đó" nghe khác hẳn "Tôi đã sửa giúp bạn".
2. **Hãy để tiến bộ hiện ra rõ ràng.** Nhìn skill tree sáng dần lên có sức nặng với động lực hơn mọi hệ thống điểm số mà chúng tôi từng thử.
3. **Hãy để họ giảng lại.** Thỉnh thoảng thú cưng nhờ người học giải thích *vì sao* một thứ lại chạy được - và mức ghi nhớ khái niệm đó tăng gần gấp đôi ở những lần theo dõi về sau.
...
Chúng tôi vẫn đang học - mỗi nhóm người dùng lại làm chúng tôi bất ngờ theo một cách mới. Nếu bạn tò mò muốn biết những nhận định này hiện ra thế nào trong sản phẩm, loạt bài [Xây dựng sản phẩm AI](/vi/blog/category/building-ai-products) kể tiếp phần kỹ thuật của cùng câu chuyện.
